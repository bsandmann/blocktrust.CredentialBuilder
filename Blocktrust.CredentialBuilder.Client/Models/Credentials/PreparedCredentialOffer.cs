...
public class PreparedCredentialOffer
{
    ...
    public PreparedCredentialOffer(EstablishedConnection establishedConnection, LocalDid issuerDid, Dictionary<string, string> claims, bool automaticIssuance, string? schemaId = null, int? validityPeriod = null)
    {
